...
(function($, window, document, undefined) {
    ...
    var popup = {
        ...
        _createMarkup: function() {
            ...
            if (t.type === 'singlePage') {
                ...
                // if there are some events than overrides the de scroll behaviour don't go to them
        ...
        openLightbox: function(blocks, currentBlock) {
            ...
            $.each(blocks, function(index, item) {
                var href = item.getAttribute('href'),
                    src = href, // de if element is image
                    type = 'isImage', // de if element is image
                    videoLink;
    ...
    var pluginObject = {
        ...
        /**
         * Extend de options and deal with the deprecated options
         */
        ...
        _beforeDisplay: function() {
            ...
            // set de filter if is present in url
            t._filterFromUrl();
    ...
    $.fn.cubeportfolio.options = {
         ...
         *  Values: - de (no adjustment applied)
         ...
         *            width automatically (de option for backward compatibility)
         */
        mediaQueries: false,
         ...
         *  Values: - de (the content will be displayed as soon as possible)
        ...
        /**
         *  Defines the speed of displaying the items (when `displayType == de` this option will have no effect)
